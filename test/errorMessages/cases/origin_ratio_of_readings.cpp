...
//
// expect: fail
// expect-match: no origin-free ratio
// expect-match: divide their differences
...
int main()
{
	auto bad = units::temperature::celsius<double>(20.5) / units::temperature::celsius<double>(10.25); // ill-formed
	(void)bad;
	return 0;
}
